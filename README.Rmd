...
<details>
  <summary>How to install GNU Scientific Library (GSL)?</summary>
...
## Tutorial
SecAct is compatible with multiple modalities of gene expression profiles, including spatial, single-cell, and bulk transcriptomics data. The following tutorials demonstrate its applications across each data type.
